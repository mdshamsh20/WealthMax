export default function Footer() {
  return (
    <footer className="bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 py-12 px-6 md:px-12">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="space-y-4 mb-8">
          ...
          <p className="text-slate-500 dark:text-slate-400 text-sm">Noida, India</p>
        </div>
